// PyTorch binding for Hopper-optimized trajectory resampling
...
torch::Tensor resample_trajectories_hopper(
    ...
    TORCH_CHECK(source_data.dtype() == torch::kBFloat16, 
                "source_data must be BFloat16 for Hopper optimization");
